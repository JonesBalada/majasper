...
public class StretchApp extends AbstractSampleApp
{
	...
	public void fill() throws JRException
	{
		...
		JasperFillManager.fillReportToFile("/tmp/StretchReport.jasper", null, new JREmptyDataSource(20));
	...
	{
		long start = System.currentTimeMillis();
		JasperPrintManager.printReport("/tmp/StretchReport.jrprint", true);
	...
	{
		long start = System.currentTimeMillis();
		JasperExportManager.exportReportToPdfFile("/tmp/StretchReport.jrprint");
	...
	{
		long start = System.currentTimeMillis();
		File sourceFile = new File("/tmp/StretchReport.jrprint");
	...
	{
		long start = System.currentTimeMillis();
		JasperExportManager.exportReportToXmlFile("/tmp/StretchReport.jrprint", false);
	...
	{
		long start = System.currentTimeMillis();
		JasperExportManager.exportReportToXmlFile("/tmp/StretchReport.jrprint", true);
		System.err.println("XML creation time : " + (System.currentTimeMillis() - start));
	}
	...
	{
		long start = System.currentTimeMillis();
		JasperExportManager.exportReportToHtmlFile("/tmp/StretchReport.jrprint");
